...
\section{Changes between OASIS3.3 and OASIS3-MCT\_4.0}
XXXXXX Should we really keep this section , maybe refer to Redmine tickets only XXXXX
\label{sec_oa2_oa3}
...
Bundled fields is now supported in the put and get interfaces to allow
easier coupling of multi-level or other related fields via a single
namcouple coupling definition and a single call to a get or put interface.
