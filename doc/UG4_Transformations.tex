...
\item The {\tt bfb} option enforces a bit-for-bit transformation regardless
  of the component grid decomposition or number of processes. It is currently using the {\tt gather} option.
\item The {\tt opt} option carries out the global sum using the most optimal algorithm available.  Currently,
