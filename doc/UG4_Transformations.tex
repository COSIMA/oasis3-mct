...
\item {\bf CHECKIN}:
 ...
 the source field values and prints them to the debug file (for the master process of the source component model only). This operation does not transform the field.
