...
Definition at line 588 of file mod\+\_\+oasis\+\_\+part.\+F90.
...
\begin{DoxyItemize}
\item Gather partition information
\begin{DoxyItemize}
\item Gather number of partitions
\item if gatherall, Gather partition names
\item if gatherall, Determine the unique partitions on the root
\item if not gatherall, Loop over tasks
\begin{DoxyItemize}
\item if not gatherall, Send partitions to root
\item if not gatherall, Recv partitions on root
\item if not gatherall, Determine the unique partitions on the root
\end{DoxyItemize}
\end{DoxyItemize}
\item Broadcast the partition information to all tasks
...
Definition at line 547 of file mod\+\_\+oasis\+\_\+part.\+F90.
...
Definition at line 519 of file mod\+\_\+oasis\+\_\+part.\+F90.
