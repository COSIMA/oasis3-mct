...
PROGRAM model1
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 269')
  ENDIF
  !
  DEALLOCATE(il_paral)
  !
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 284')
  ENDIF
  !
  !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ! SEND ARRAYS 
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 350')
  ENDIF
  !
  !
END PROGRAM MODEL1
