...
PROGRAM model1
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 112')
  ENDIF
  !
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 119')
  ENDIF
  !
  !!!!!!!!!!!!!!!!! OASIS_GET_LOCALCOMM !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 140')
  ENDIF
  !
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 283')
  ENDIF
  !
  DEALLOCATE(il_paral)
  !
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 299')
  ENDIF
  !
  !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ! SEND ARRAYS 
  ...
  IF ( ierror .NE. OASIS_Ok .AND. ierror .LT. OASIS_Sent) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 343')
  ENDIF
  !
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  IF (ierror /= 0) THEN
      ...
      CALL oasis_abort(comp_id,comp_name,'Problem at line 372')
  ENDIF
  !
  !
END PROGRAM MODEL1
