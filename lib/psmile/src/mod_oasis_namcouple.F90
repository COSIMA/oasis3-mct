...
! --- mod_string
  ...
  CHARACTER(len=jpeighty)        ,DIMENSION(:),ALLOCATABLE :: cg_name_rstfile
  CHARACTER(len=jpeighty)        ,DIMENSION(:),ALLOCATABLE :: cg_restart_file
  CHARACTER(len=32)        ,DIMENSION(:),ALLOCATABLE :: cficinp
  CHARACTER(len=8)         ,DIMENSION(:),ALLOCATABLE :: cficout
  CHARACTER(len=jpeighty)        ,DIMENSION(:),ALLOCATABLE :: cg_input_file
